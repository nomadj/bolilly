...
// TODO: replace with your contract values
const CONTRACT_ADDRESS = "0x1Be4b6E886B8b20E17e4754EC219E86C1C808e6b";
...
const ConnectWalletPrompt: FC = () => {
  ...
  const handleThumbsUp = async () => {
    try {
      ...
      const tx = await contract.mintStudent(addr, "bob", "chemistry");
      toaster.create({
        title: "Minting...",
